...
func taskPluginProtocolHandlers(protocol, operation string) ([]gin.HandlerFunc, error) {
	...
	case "openai_responses.create":
		return []gin.HandlerFunc{
			...
			middleware.ModelRequestRateLimit(), middleware.PrivacyFilter(), middleware.PinTaskPluginEndpoint(), middleware.PrepareTaskPluginEndpoint(), middleware.Distribute(),
			func(c *gin.Context) {
	...
	case "openai_video.create":
		return []gin.HandlerFunc{
			...
			middleware.PrivacyFilter(), middleware.PinTaskPluginEndpoint(), middleware.TaskPluginEndpointOnly(middleware.ModelRequestRateLimit()), middleware.PrepareTaskPluginEndpoint(), middleware.Distribute(),
